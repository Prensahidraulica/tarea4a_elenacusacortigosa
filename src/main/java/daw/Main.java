...
public class Main {
    public static void main(String[] args) {
         ...
         * o la puerta que da al pasillo. En cada una de estas estancias pueden pasar dos situaciones, una siempre es tenebrosa y la otra es que
        ...
        if (puertaOVentana.equalsIgnoreCase("puerta")) {
          ...
          String casoPuerta = Juegos.CasoVentana();
        }
    }
}